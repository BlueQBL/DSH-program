    ...
    return [
      ...
      },
      {
        ...
        body: [
          ...
          '- 「设置」里能换主题：校样、One Dark、Dracula、Night Owl、Monokai、Nord、',
          '  Solarized 深浅、GitHub 深浅，一共十套；',
          '- 同一处还能换 Markdown 风格：GitHub / 标准 / 论文 / 中文写作 / 全扩展——',
          '  选「论文风格」试试，标题和图片会自动编号（1 / 1.1 / 1.1.1、图 1）；',
          '- 「导出 PDF」走浏览器打印，中文字体和公式都是矢量，能选中能搜索，文件名就是标题。',
          '',
          '## 常用代码块标注',
          '',
          '```diff',
